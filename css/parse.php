 ...
 */
$config['set_etag'] = true; //we are using Version Control with Cachebusting [https://github.com/paulirish/html5-boilerplate/wiki/Version-Control-with-Cachebusting]
